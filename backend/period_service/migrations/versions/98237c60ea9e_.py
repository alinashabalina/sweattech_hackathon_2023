...
Revision ID: 98237c60ea9e
Revises: 
Create Date: 2023-11-18 16:08:06.447949
...
def upgrade():
    ...
    sa.Column('hormone_state', sa.String(length=255), nullable=True),
    sa.Column('day_of_cycle', sa.Integer(), nullable=True),
    sa.Column('goal_list', sa.String(length=255), nullable=True),
